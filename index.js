...
function createMenuItem(name, price, category){
  ...
  console.log(createMenuItem('chetos', '12', 'lunch'));
...
*/
console.log(createMenuItem('rice', '15', 'Dinner'));
console.log(createMenuItem('donut', '4', 'Brunch'));
...
*/
//Reyner's feedback: "this place is chill with really cool people, great for getting work done on weekdays"
reviews.push({name:'Reyner', rating: 3.5, feedback:'this place is chill with really cool people, great for getting work done on weekdays'})
